                        ...
                        <div className="bg-gradient-to-b from-gray-900 to-black border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
                            ...
                            <div className="relative px-6 pb-6">
                                ...
                                <div className="relative -mt-16 mb-4">
                                    ...
                                    {/* Online Status */}
                                    <div className="absolute bottom-1 right-1/2 translate-x-10 w-5 h-5 bg-green-500 border-2 border-gray-900 rounded-full" />
                                </div>
                                ...
                                {user.linkedAccounts && user.linkedAccounts.length > 0 && (
                                    <div className="flex justify-center gap-3 mb-6">
                                        {user.linkedAccounts.map((acc, i) => (
                                            ...
                                            >
                                                {getPlatformIcon(acc.platform, "w-4 h-4 text-gray-400")}
                                                <span className="text-sm text-gray-300">@{acc.handle}</span>
                                            </a>
                                        ))}
                                    </div>
                                )}
